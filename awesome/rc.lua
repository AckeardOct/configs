...
beautiful.init("/home/acc/.config/awesome/themes/dust/theme.lua")
...
web_browser  = "chromium --password-store=basic"
...
mymainmenu = freedesktop.menu.build({
    ...
    before = {
        ...
        { "Browser", web_browser, menubar.utils.lookup_icon("internet-web-browser") },
        { "Files", file_browser, menubar.utils.lookup_icon("system-file-manager") },
...
local tasklist_buttons = gears.table.join(
                     ...
                     awful.button({ }, 3, function(c) c:kill() end), -- kill window
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "F3", function () awful.spawn("reboot") end,
                  ...
                  function ()
                      if client.focus then
                          ...
                          if tag then
                              ...
                              tag:view_only() -- move and show tag
                          end
                     end
                  end,
...
--awful.spawn.easy_async("~/.config/awesome/autorun.sh")
